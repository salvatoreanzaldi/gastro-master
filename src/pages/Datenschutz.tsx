  ...
  <div className="min-h-screen bg-background">
    ...
    <main className="section-padding pt-44 md:pt-52">
      <div className="container-tight max-w-3xl">
        ...
        <p className="text-muted-foreground text-sm mb-12">Stand: März 2026</p>
        ...
        <section className="mb-10">
          <h2 className="text-xl font-bold text-foreground mb-3">2. Datenschutzbeauftragter</h2>
          <p className="text-muted-foreground leading-relaxed mb-3">
        ...
        <section className="mb-10">
          <h2 className="text-xl font-bold text-foreground mb-3">3. Übersicht der Verarbeitungen</h2>
        ...
        {/* 4. Rechtsgrundlagen */}
        <section className="mb-10">
          <h2 className="text-xl font-bold text-foreground mb-3">4. Rechtsgrundlagen der Verarbeitung</h2>
          <p className="text-muted-foreground leading-relaxed mb-3">
        ...
        <section className="mb-10">
          <h2 className="text-xl font-bold text-foreground mb-3">5. Sicherheitsmaßnahmen</h2>
          <p className="text-muted-foreground leading-relaxed mb-3">
        ...
        <section className="mb-10">
          <h2 className="text-xl font-bold text-foreground mb-3">6. Datenübermittlung an Drittländer</h2>
          <p className="text-muted-foreground leading-relaxed mb-3">
        ...
        {/* 7. Speicherdauer */}
        <section className="mb-10">
          <h2 className="text-xl font-bold text-foreground mb-3">7. Speicherdauer und Löschung</h2>
          <p className="text-muted-foreground leading-relaxed mb-3">
        ...
        <section className="mb-10">
          <h2 className="text-xl font-bold text-foreground mb-3">8. Rechte der betroffenen Personen</h2>
          <p className="text-muted-foreground leading-relaxed mb-3">
        ...
        {/* 9. Server-Logfiles */}
        <section className="mb-10">
          <h2 className="text-xl font-bold text-foreground mb-3">9. Server-Logfiles</h2>
        ...
        {/* 10. Cookies */}
        <section className="mb-10">
          <h2 className="text-xl font-bold text-foreground mb-3">10. Cookies und Einwilligungsmanagement</h2>
          <RolleVerantwortlicher />
          <p className="text-muted-foreground leading-relaxed mb-4">
        ...
        {/* 11. Bestellungen und Vertragsabwicklung */}
        <section className="mb-10">
          <h2 className="text-xl font-bold text-foreground mb-3">11. Bestellungen und Vertragsabwicklung</h2>
        ...
        {/* 12. Kundenkonto */}
        <section className="mb-10">
          <h2 className="text-xl font-bold text-foreground mb-3">12. Kundenkonto</h2>
          <RolleAuftragsverarbeiter />
          <p className="text-muted-foreground leading-relaxed mb-2">
        ...
        {/* 13. Kontaktformular */}
        <section className="mb-10">
          <h2 className="text-xl font-bold text-foreground mb-3">13. Kontaktformular und E-Mail-Kontakt</h2>
          <RolleVerantwortlicher />
          <p className="text-muted-foreground leading-relaxed mb-2">
        ...
        {/* 14. Newsletter */}
        <section className="mb-10">
          <h2 className="text-xl font-bold text-foreground mb-3">14. Newsletter und E-Mail-Marketing</h2>
        ...
        <section className="mb-10">
          <h2 className="text-xl font-bold text-foreground mb-3">
            15. WhatsApp-Newsletter und Marketing via Superchat
          </h2>
          <p className="text-muted-foreground leading-relaxed mb-4">
        ...
        {/* 16. Google reCAPTCHA */}
        <section className="mb-10">
          <h2 className="text-xl font-bold text-foreground mb-3">16. Google reCAPTCHA</h2>
          <RolleVerantwortlicher />
          <p className="text-muted-foreground leading-relaxed mb-2">
        ...
        {/* 17. Google Analytics */}
        <section className="mb-10">
          <h2 className="text-xl font-bold text-foreground mb-3">17. Google Analytics</h2>
          <RolleVerantwortlicher />
          <p className="text-muted-foreground leading-relaxed mb-2">
        ...
        {/* 18. Google Maps */}
        <section className="mb-10">
          <h2 className="text-xl font-bold text-foreground mb-3">18. Google Maps – Liefergebietsverwaltung</h2>
          <RolleAuftragsverarbeiter />
          <p className="text-muted-foreground leading-relaxed mb-3">
        ...
        <section className="mb-10">
          <h2 className="text-xl font-bold text-foreground mb-3">19. Zahlungsdienstleister</h2>
        ...
        {/* 20a. Hosting */}
        <section className="mb-10">
          <h2 className="text-xl font-bold text-foreground mb-3">20a. Hosting und eigene Plattform-Infrastruktur</h2>
          <p className="text-muted-foreground leading-relaxed mb-3">
        ...
        <section className="mb-10">
          <h2 className="text-xl font-bold text-foreground mb-3">
            20b. Verarbeitung von Kundendokumenten (Onboarding und Vertragsbasis)
          </h2>
          <RolleVerantwortlicher />
          <p className="text-muted-foreground leading-relaxed mb-3">
        ...
        {/* 20c. Stripe */}
        <section className="mb-10">
          <h2 className="text-xl font-bold text-foreground mb-3">20c. Stripe – Zahlungsabwicklung und Konto-Einrichtung</h2>
          <RolleVerantwortlicher />
          <p className="text-muted-foreground leading-relaxed mb-2">
        ...
        {/* 20d. GoCardless */}
        <section className="mb-10">
          <h2 className="text-xl font-bold text-foreground mb-3">20d. GoCardless – SEPA-Lastschrift / Abonnements</h2>
          <RolleVerantwortlicher />
          <p className="text-muted-foreground leading-relaxed mb-2">
        ...
        {/* 20e. Make */}
        <section className="mb-10">
          <h2 className="text-xl font-bold text-foreground mb-3">20e. Prozessautomatisierung – Make</h2>
          <RolleVerantwortlicher />
          <p className="text-muted-foreground leading-relaxed mb-2">
        ...
        {/* 20f. Zoho */}
        <section className="mb-10">
          <h2 className="text-xl font-bold text-foreground mb-3">20f. Zoho – Unternehmens-Software</h2>
          <RolleVerantwortlicher />
          <p className="text-muted-foreground leading-relaxed mb-3">
        ...
        <section className="mb-10">
          <h2 className="text-xl font-bold text-foreground mb-3">20g. Projektmanagement und Dokumentenablage</h2>
          <RolleVerantwortlicher />
          <p className="text-muted-foreground leading-relaxed mb-3">
        ...
        {/* 20i. Social Media */}
        <section className="mb-10">
          <h2 className="text-xl font-bold text-foreground mb-3">20i. Social-Media-Präsenzen</h2>
          <RolleVerantwortlicher />
          <p className="text-muted-foreground leading-relaxed mb-4">
        ...
        <section className="mb-10">
          <h2 className="text-xl font-bold text-foreground mb-3">21. Empfänger und Auftragsverarbeiter</h2>
          <p className="text-muted-foreground leading-relaxed mb-3">
        ...
        <section className="mb-10">
          <h2 className="text-xl font-bold text-foreground mb-3">22. Widerspruchsrecht gemäß Art. 21 DSGVO</h2>
          <p className="text-muted-foreground leading-relaxed mb-3">
        ...
        {/* 23. Änderung */}
        <section className="mb-10">
          <h2 className="text-xl font-bold text-foreground mb-3">23. Änderung dieser Datenschutzerklärung</h2>
          <p className="text-muted-foreground leading-relaxed">
