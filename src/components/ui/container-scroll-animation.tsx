...
export const ContainerScroll = ({
  ...
  return (
    ...
    >
      <div
        className="pt-24 pb-10 md:pt-8 md:pb-10 w-full relative"
        style={{
          perspective: "1000px",
        }}
      >
  ...
  return (
    <motion.div
      style={{
        ...
        scale,
        willChange: "transform",
        ...(isMobile ? {} : { boxShadow: "0 0 #0000004d, 0 9px 20px #0000004a, 0 37px 37px #00000042, 0 84px 50px #00000026, 0 149px 60px #0000000a, 0 233px 65px #00000003" }),
      }}
